    ...
    <el-container class="all">
      <el-header class="header" height="6%">
        <div style="width: 100%;height=100%">
            ...
            <el-avatar :size="50" :src="currentUser.avatar" style="margin-left: 5px;margin-top: 2px;"/>
        </div>
      </el-header>
      <el-container>
        <el-aside width="20%" class="aside">
            <div style="width: 100%;height=20px;margin-top: 10px;margin-left: 10px;display: flex;">
                ...
                <el-input v-model="input" style="width: 70%;margin-left:10px" :prefix-icon="SearchIcon" placeholder="搜索"/>
            </div>
        </el-aside>
