<template>
    <div style="width: 100%; height: 100%;position: relative;">
        ...
        <div style="width: 100%; height: 7%;display: flex;justify-content: center;align-items: center;">
            ...
            <div >
                <el-input type="textarea" v-model="current_wkt" style="width: 640px" placeholder="例：113,23" />
            </div>
...
<script setup>
    ...
    import {gis} from '@/components/js/GISUtils.js'
...
<style scoped>
    ...
    .map_s1{
        width: 100%; height: 80%;min-width: 100%;min-height: 80%;position: relative;
    }
    .map_s2{
