    ...
    <OrderDet :open="isopen_order" @close="child_method" :dataCom="dataCom" @pay="payiii"/>
        ...
        <el-card class="box-card">
            <div class="top-card" @click="opendraw" >
                <el-image style="width: 100%; height: 90% ;margin:  auto" :src="fileOps.getFile+data.showImg" fit="fill" />
            </div>
            <div class="bottom-card">
                ...
                <div style="width:100%;height:50%;display:flex;align-items:center;">
                    <span class="card-title" style="font-size: 18px;width:60%;display: -webkit-box; -webkit-box-orient: vertical;
                                                            -webkit-line-clamp: 2;overflow: hidden;word-break: break-all;  ">{{data.desText}}</span>
                    <div style="width:40%;flex:1;display:flex;justify-content: flex-end;align-items:center;">
